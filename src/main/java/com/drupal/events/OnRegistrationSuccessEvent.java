...
public class OnRegistrationSuccessEvent extends ApplicationEvent {
	...
	/**
	 * Returns the registration type- Institute or User
	 * 
	 * @return the RegistrationTypes of the user/institute
	 */
	...
	/**
	 * Returns the userId of the user/institute for which this event is generated
	 * 
